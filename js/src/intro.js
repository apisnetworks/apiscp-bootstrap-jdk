 ...
 *
 * Date: Fri, 19 Mar 2021 21:46:20 GMT
 */
...
(function (global, factory) {
  ...
  */
  ...
  function _determineAutoPosition(targetElement, tooltipLayer, desiredTooltipPosition) {
    ...
    var targetElementRect = targetElement.getBoundingClientRect(); // tooltip can be located above or below without overhanging viewport

    var withinViewport = windowSize.width - Math.abs(targetElementRect.left) > tooltipWidth && windowSize.width - Math.abs(targetElementRect.right) > tooltipWidth; // If we check all the possible areas, and there are no valid places for the tooltip, the element
